...
class Inference():
    ...
    def infer(self):
        ...
        output_rule = max(self.membership_dict["chest_pain"]["asymptomatic"] , self.membership_dict["age"]["very_old"])
        ...
        temp = self.diagnosis_dict["sick_1"]
        output_rule = max(self.membership_dict["blood_pressure"]["high"] , self.membership_dict["heart_rate"]["low"])
        self.diagnosis_dict["sick_1"] = max(temp, output_rule)
        ...
        temp = self.diagnosis_dict["healthy"]
        output_rule = self.membership_dict["cholestrol"]["low"]
        self.diagnosis_dict["healthy"] = max(temp, output_rule)
         
        # RULE 24: IF (cholestrol IS medium) THEN health IS sick_1;
        temp = self.diagnosis_dict["sick_1"]
        output_rule = self.membership_dict["cholestrol"]["medium"]
        self.diagnosis_dict["sick_1"] = max(temp, output_rule)
         
        # RULE 25: IF (cholestrol IS high) THEN health IS sick_2;
        temp = self.diagnosis_dict["sick_2"]
        output_rule = self.membership_dict["cholestrol"]["high"]
        self.diagnosis_dict["sick_2"] = max(temp, output_rule)
        ...
        temp = self.diagnosis_dict["sick_4"]
        output_rule = self.membership_dict["cholestrol"]["very_high"]
        self.diagnosis_dict["sick_4"] = max(temp, output_rule)
        ...
        temp = self.diagnosis_dict["sick_2"]
        output_rule = self.membership_dict["thallium_scan"]["medium"]
        self.diagnosis_dict["sick_2"] = max(temp, output_rule)
         
        # RULE 48: IF (thallium_scan IS high) THEN health IS sick_3;
        temp = self.diagnosis_dict["sick_3"]
        output_rule = self.membership_dict["thallium_scan"]["high"]
        self.diagnosis_dict["sick_3"] = max(temp, output_rule)
